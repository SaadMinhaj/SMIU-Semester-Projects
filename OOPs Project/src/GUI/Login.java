...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("or create new account");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        rs=db.matchLogin(passwordString,email.getText());
        try{
            if(rs.next()){
                User loggedInUser = new User(email.getText());
                SessionManager.setCurrentUser(loggedInUser);
                Home dash = new Home();
                dash.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(this,"incorrect details","login alert",3);
            }
        }catch(Exception e){
